...
/obj/effect/plant/hivemind/attackby(obj/item/W, mob/user)
	...
	if(weapon_type)
		if(W.use_tool(user, src, WORKTIME_FAST, weapon_type, FAILCHANCE_EASY, required_stat = SKILL_REP)) //Replaced STAT_ROB with STAT_MEC. you aren't ripping this out you are cutting it
