...
/**
 * Removes the current mutable appearance from all of the affected areas overlays.
 */
...
/**
 * Applies the current mutable appearance to all of the affected areas overlays.
 */
