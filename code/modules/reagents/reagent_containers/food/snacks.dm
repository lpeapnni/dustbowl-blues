			...
			switch(chef_buff_type)
				if(1)
					if(eater.stats)
						if(eater.stats.getTempStat(stat,"spicyfood"))
							...
							eater.stats.addTempStat(SKILL_SCI, 15, cheftimer, "spicyfood")
				...
				if(2)
					if(eater.stats)
						if(eater.stats.getTempStat(stat,"spicyfood"))
							eater.stats.removeTempStat(stat, "spicyfood")
							eater.stats.addTempStat(SKILL_REP, 15, cheftimer, "spicyfood")
							to_chat(eater, SPAN_NOTICE("Your knowledge of Cognition feels renewed after eating something this delicious!"))
					eater.stats.addTempStat(SKILL_REP, 15, cheftimer, "spicyfood")
				...
				if(3)
					if(eater.stats)
						if(eater.stats.getTempStat(stat,"spicyfood"))
							eater.stats.removeTempStat(stat, "spicyfood")
							eater.stats.addTempStat(SKILL_MED, 15, cheftimer, "spicyfood")
							to_chat(eater, SPAN_NOTICE("Your knowledge of Cognition feels renewed after eating something this delicious!"))
					eater.stats.addTempStat(SKILL_MED, 15, cheftimer, "spicyfood")
				...
				if(4)
					if(eater.stats)
						if(eater.stats.getTempStat(stat,"spicyfood"))
							eater.stats.removeTempStat(stat, "spicyfood")
							eater.stats.addTempStat(SKILL_ATH, 15, cheftimer, "spicyfood")
...
/obj/item/reagent_containers/food/snacks/grown/potato/attackby(obj/item/I, mob/user)
	if(QUALITY_CUTTING in I.tool_qualities)
		if(I.use_tool(user, src, WORKTIME_NEAR_INSTANT, QUALITY_CUTTING, FAILCHANCE_ZERO, required_stat = SKILL_SUR))
