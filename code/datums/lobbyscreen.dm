...
/datum/lobbyscreen/ship
	image_file = 'icons/title_screens/los_skyscrapers.png'
	possibleMusic = list(
		'sound/music/lobby/lobby1.ogg',
		'sound/music/lobby/lobby2.ogg',
		'sound/music/lobby/lobby3.ogg',
		'sound/music/lobby/lobby4.ogg',
		'sound/music/lobby/lobby5.ogg'
		)
