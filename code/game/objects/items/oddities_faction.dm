		...
		if(locate(/mob/living/carbon/, L))
			for(var/mob/living/carbon/M in L)
				...
				if(I && I.active && I.wearer)
					continue
				M.stats.addTempStat(STAT_TGH, -SKILL_LEVEL_ADEPT, 45 SECONDS)
				M.stats.addTempStat(STAT_VIG, -SKILL_LEVEL_ADEPT, 45 SECONDS)
				M.stats.addTempStat(STAT_ROB, -SKILL_LEVEL_ADEPT, 45 SECONDS)
				M.stats.addTempStat(STAT_BIO, -SKILL_LEVEL_ADEPT, 45 SECONDS)
				M.stats.addTempStat(STAT_COG, -SKILL_LEVEL_ADEPT, 45 SECONDS)
				M.stats.addTempStat(STAT_MEC, -SKILL_LEVEL_ADEPT, 45 SECONDS)
