...
/obj/item/mine_old/attackby(obj/item/I, mob/user)
	...
	if(I.use_tool(user, src, WORKTIME_NORMAL, QUALITY_WIRE_CUTTING, FAILCHANCE_NORMAL,  required_stat = SKILL_EXP)) //disarming a mine with a multitool should be for smarties
		user.visible_message(
